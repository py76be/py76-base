...
2. Go to your repository at [py76be/py76-base](https://github.com/py76be/py76-base).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `demo.py76.be` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | demo.py76.be | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/py76be/py76-base/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/py76be/py76-base/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/py76be/py76-base-backend`) and Frontend (`ghcr.io/py76be/py76-base-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of demo.py76.be](https://github.com/py76be/py76-base/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/demo.py76.be.yml` stack.
